...
if(isset($_GET['action']) && $_GET['action'] == 'modifier' && !empty($_GET['id_annonce'])){
  ...
  $photoId = $infos_annonce['photo_id'];
...
if (
  ...
  // Controle sur le titre de l'annonce
...
<main class="container">
  <div class="bg-light p-5 rounded">
    <h1>Vos annonces</h1>
    <p class="lead">Créez ou modifiez vos annonces<hr><?php echo $msg; ?>
    </p>
  </div>
    ...
    <div class="col-12 mt-5">
      ...
      <form class="row border p-3" method="post" enctype="multipart/form-data">
        ...
        <div class="col-sm-6">
          <?php if(!empty($photo)) { ?>
            <div class="mb-3">
            <label for="photo" class="form-label"> <i class="text-primary fas fa-user-alt"></i></label>
